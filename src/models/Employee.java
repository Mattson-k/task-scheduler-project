...
public class Employee {
    public static final int hoursPerDay=10; // The amount of working hours a day for each Employee
   ...
   private  String name;
    ...
    public Employee(String name, String email, String department, int hoursLeft, String team) {
        this.name = name;
        this.email = email;
    ...
    void work () {
        ...
        if (this.getCurrentTask()!=null && this.getCurrentTask().getWorkingHours()!=0) { // If the Employee has a current task and the task is not finished yet
            ...
            if (this.getHoursLeft()>this.getCurrentTask().getWorkingHours()) { // If the Employee can finish the Task before the end of the working day
                ...
                if (this.getAllwork().getCurrentUnassignedTask()!=-1) { // If there are available Tasks
                ...
                if (this.getHoursLeft()==this.getCurrentTask().getWorkingHours()) {
                    ...
                    System.out.println("* //// " + this.getName() + " has finished " + this.getCurrentTask()
                                                                                           .getName() + ".\n"); // A Message that the Employee has finished the Task
